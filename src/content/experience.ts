...
export const experience: ExperienceEntry[] = [
  {
    ...
    responsibilities: [
      ...
      "Engineered temporal features by decomposing journey, departure and arrival timestamps, encoded airline, source and destination, and mapped stop count ordinally.",
      "Benchmarked six models and justified the final choice on the structure of the data and the deployment constraint rather than the leaderboard.",
    ...
    achievements: [
      ...
      "Shipped it as a static Hugging Face Space with the model serialised to JavaScript and evaluated in the browser: no backend, no cold start, and predictions matching scikit-learn to within 8.2e-9 rupees. Still live.",
    ],
  },
];
